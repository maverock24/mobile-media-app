...
|---|---------|---------|--------|--------|------|
| 1 | Audio Playback Lifecycle | Now-playing state hub across Music, Podcast, Radio, Mixer; audio exclusivity, stream reconnect, Android background recovery | 5 | `src/lib/stores/mediaEngine.svelte.ts` | [audio-playback-lifecycle.md](./audio-playback-lifecycle.md) |
